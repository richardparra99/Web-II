...
module.exports = (app) => {
    ...
    router.post("/", isJsonRequestValid, validateJson(artistaSquema),controller.crearArtistas);
    router.put("/:id", isJsonRequestValid, validateJson(artistaSquema), getObjectOr404(db.artista), controller.actulizarArtistaPut);
    router.patch("/:id", isJsonRequestValid, validateJson(artistaOptionalSquema), getObjectOr404(db.artista), controller.actualizarArtistaPatch);
    ...
    router.post("/:id/generos", isJsonRequestValid, validateJson(artistaGeneroSquema), controller.setGeneros);
