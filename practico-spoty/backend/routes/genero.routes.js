...
module.exports = app => {
    ...
    router.post("/", isJsonRequestValid, validateJson(generoSquema), controller.crearGenero);
    router.put("/:id", isJsonRequestValid, validateJson(generoSquema), getObjectOr404(db.genero), controller.actualizarGeneroPut);
    router.patch("/:id", isJsonRequestValid, validateJson(generoOptionalSquema), getObjectOr404(db.genero),controller.actualizarGeneroPatch);
    router.get("/:id", getObjectOr404(db.genero), controller.getGeneroById);
    router.delete("/:id", getObjectOr404(db.genero), controller.elimilarGenero);
